...
//       $('#physics').show();
//       $('.blue_figcaption').removeClass('blue_figcaption').addClass('new_caption');
//     });
//   }).mouseleave(function(){
//     $('.blue-anim .moving_img').stop(false,true);
//     $('#physics').hide();
//     $('.blue-anim .moving_img').fadeIn(0, function(){
//       $('.new_caption').text('Physics').removeClass('new_caption').addClass('blue_figcaption');
//     });
//   });
...
//       $('#web').show();
//       // $('.red_figcaption').text("Web-Dev").removeClass('red_figcaption').addClass('red_new_caption');
//     });
//   }).mouseleave(function(){
//     $('.red-anim .moving_img').stop(false,true);
//     $('#web').hide();
//     $('.red-anim .moving_img').fadeIn(0, function(){
//       $('.red_new_caption').removeClass('red_new_caption').addClass('red_figcaption');
//     });
//   });
